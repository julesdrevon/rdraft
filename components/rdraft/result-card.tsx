...
export function ResultCard({
  ...
  return (
    <button
      ...
      className="group border-gold/15 hover:border-gold/45 relative aspect-[308/560] w-[17vw] max-w-[150px] cursor-pointer overflow-hidden rounded-lg border shadow-2xl transition-colors sm:w-[15vw] sm:max-w-[230px]"
    >
      <Image
